    ...
    execute: function () {
      ...
      _export("GameView", GameView = class GameView {
        ...
        loadSpriteFrameByPath(path, sprite) {
          ...
          var cached = this.spriteFrameCache.get(path);
        ...
        getPlantSpritePathByVariant(variant) {
          var safeIndex = Math.abs(variant != null ? variant : 0) % PLANT_SPRITE_PATHS.length;
        ...
        renderHand(handSlots) {
          ...
          for (var i = 0; i < this.handViews.length; i++) {
            ...
            for (var cell of card.cells) {
              ...
              this.loadSpriteFrameByPath(this.getPlantSpritePathByVariant((_cell$plantVariant = cell.plantVariant) != null ? _cell$plantVariant : 0), _artCell.sprite);
            }
        ...
        syncBoardPlants(state, cellSize) {
          ...
          if (state.preview) {
            ...
            for (var _cell of state.preview.cells) {
              ...
              this.loadSpriteFrameByPath(this.getPlantSpritePathByVariant(_cell.plantVariant), _view2.sprite);
              visible.push(_view2);
            }
          }
