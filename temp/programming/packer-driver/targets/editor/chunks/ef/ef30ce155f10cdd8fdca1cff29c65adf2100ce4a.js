    ...
    execute: function () {
      ...
      _export("MainGame", MainGame = (_dec = ccclass('MainGame'), _dec(_class = class MainGame extends Component {
        ...
        confirmPreplacePlace() {
          ...
          const oldIds = this.model.hand.map(card => card.id);
          const handSnap = (_this$view = this.view) == null ? void 0 : _this$view.captureHandLayoutSnapshot();
        ...
        rotate(direction) {
          ...
          const currentAnchor = (_this$lockedPreplaceA = this.lockedPreplaceAnchor) != null ? _this$lockedPreplaceA : this.hoverAnchor;
          const nextRotation = (this.currentRotation + direction + 4) % 4;

          if (currentAnchor) {
            const adjustedAnchor = this.getRotatedAnchorWithKick(card, currentAnchor, this.currentRotation, nextRotation);
        ...
        gmDrawCard() {
          ...
          const oldIds = this.model.hand.map(card => card.id);
          const handSnap = (_this$view2 = this.view) == null ? void 0 : _this$view2.captureHandLayoutSnapshot();
        ...
        getCurrentPreview() {
          ...
          const anchor = (_this$lockedPreplaceA2 = this.lockedPreplaceAnchor) != null ? _this$lockedPreplaceA2 : this.hoverAnchor;
